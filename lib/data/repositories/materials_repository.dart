...
abstract class MaterialsRepository {
  ...
  Future setLocalMaterials({required String customerSAP, required MaterialsCatalog materialsCatalog});
...
class MaterialsRepositoryImpl implements MaterialsRepository {
  ...
  @override
  Future<MaterialsCatalog> getRemoteCatalog({required String customerSAP}) => materialsRemoteDatasource.getCatalog(customerSAP: customerSAP);

  @override
  Future<MaterialsCatalog> getLocalMaterials({required String customerSAP}) => materialsLocalDataSource.getMaterials(customerSAP: customerSAP);

  @override
  Future setLocalMaterials({required String customerSAP, required MaterialsCatalog materialsCatalog}) =>
      materialsLocalDataSource.setMaterials(customerSAP: customerSAP, materialsCatalogModel: MaterialsCatalogModel.fromEntity(materialsCatalog));

  @override
  Future<SyncData> getMaterialsSyncData({required String customerSAP}) => materialsLocalDataSource.getMaterialsSyncData(customerSAP: customerSAP);

  @override
  Future setMaterialsSyncData({required String customerSAP, required SyncData syncData}) =>
      materialsLocalDataSource.setMaterialsSyncData(customerSAP: customerSAP, syncData: syncData);

  Future subscribeToMaterial({required String customerSAP, required String materialNumber}) =>
      materialsRemoteDatasource.subscribeToMaterial(customerSAP: customerSAP, materialNumber: materialNumber);
}
