...
class UserErrorMaterialComponentState extends State<UserErrorMaterialComponent> {
  @override
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
            ...
            gradient: LinearGradient(colors: [MyColors.red_EF6262, MyColors.red_C82B2B], begin: Alignment.topCenter, end: Alignment.bottomCenter)),
        child: Padding(
