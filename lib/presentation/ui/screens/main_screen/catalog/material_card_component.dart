...
class MaterialCardComponentState extends State<MaterialCardComponent> {
  ...
  Widget build(BuildContext context) {
    if(type is ComponentOutOfStockItem){
      return getOufOfStock(isUpdate: (type as ComponentOutOfStockItem).isUpdate);
    }
  ...
  Widget getUpSale(){
    return Container(child:Column(children: [
      ...
      child: Padding(padding: EdgeInsets.only(left: Get.width*0.04, right: Get.width*0.03),child:
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
          ...
          Image.asset("assets/icons/sale.png", height: 18,width: Get.width*0.07,)),
    ...
    return Container(
      child: Column(children: [
        ...
        Container(
          ...
          child: Padding(padding: EdgeInsets.only(left: Get.width*0.05,
              right: Get.width*0.05, bottom: 5, top: 5),child:
          Stack(
    ...
    return Container(
      child: Column(children: [
        Container(
          ...
          alignment: Alignment.center,
          height: 44,
          decoration: BoxDecoration(color: isUpdate? MyColors.blue_007AFE: MyColors.blue_003E83,
          borderRadius: BorderRadius.all(Radius.circular(20))),
          child: isUpdate?
          Padding(padding: EdgeInsets.only(left:Get.width*0.05, right: Get.width*0.05 ),
              child:Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
            Text("We'll update as soon as it's back in stock",
            style: TextStyle(color: Colors.white),),
            Icon(Icons.check, color: Colors.white,),

          ],)):Text("Not in stock, update when he gets back?",
            style: TextStyle(color: Colors.white) ,),)
      ],),
  ...
  Widget getAlternateProduct({required bool isOriginal}){
    ...
    child:isOriginal?Text("Alternative product", style: TextStyle(
        color: MyColors.blue_37C33A,
    fontSize: 18),):Padding(padding: EdgeInsets.only(left: Get.width*0.05, right: Get.width*0.05), child:Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: [
      Text("Back to original product", style: TextStyle(color: MyColors.blue_37C33A,
          fontSize: 18),),
      SizedBox(width: Get.width*0.01,),
      Icon(Icons.chevron_right, color:MyColors.blue_37C33A,)
    ],)))],);
  }
            ...
            Row(
              ...
              children: [
                ...
                Icon(Icons.check, color: Colors.white, size: 18,),
                  SizedBox(width: Get.width*0.01,),
                Text("Supplied!", style: TextStyle(fontSize: 18,
                    color: Colors.white),)],),
                Row(children: [
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.only(bottomRight: Radius.circular(15),
                bottomLeft: Radius.circular(15)) ,
            gradient: LinearGradient(colors: [
              MyColors.blue_3B99FF,
              MyColors.blue_027BFE
            ], begin: Alignment.topCenter, end: Alignment.bottomCenter)),
        child: Padding(padding: EdgeInsets.only(left: Get.width*0.05,
        right: Get.width*0.05, bottom: 5, top: 5),child: Row(children: [
          Image.asset("assets/icons/error.png", height: 24,),
          SizedBox(width: Get.width*0.04,),
          Text("This product was partially supplied, supplied:\n300 out of 600 units",
            maxLines: 2,
  ...
  Widget getUserError(){
    return Container(
      ...
      width: Get.width,
        ...
        child: Padding(padding: EdgeInsets.only(left: Get.width*0.05,
            right: Get.width*0.05, bottom: 5, top: 5),child:
          Text("Here will come an error message",
            maxLines: 2,
