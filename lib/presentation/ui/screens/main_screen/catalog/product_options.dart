...
class ProductOptions extends StatefulWidget{
  ...
  final bool isFrozen;
  ProductOptions({required this.isNew, required this.isHotSale, required this.isFrozen});
  @override
    ...
    return Container(
      ...
      child: Column(
        ...
        Visibility(
          ...
          margin: EdgeInsets.only(top: Get.width*0.01, ),
          decoration: BoxDecoration(color: MyColors.blue_6DA5EC,
          shape: BoxShape.circle),
          child: Icon(Icons.ac_unit_outlined,
          color: MyColors.blue_003E83,size: 16,),))
      ],),
