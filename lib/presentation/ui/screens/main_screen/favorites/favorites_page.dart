          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Image.asset(
                  "assets/icons/favorites_list.png",
        ...
        child: Row(
          ...
          children: [
            Row(
              children: [
                Image.asset(
                  "assets/icons/favorites_cart.png",
            ...
            Row(
              children: [
                Padding(
                    padding: EdgeInsets.symmetric(horizontal: Get.width * 0.01),
                    child: Image.asset(
                      "assets/icons/favorites_sort.png",
                      width: Get.width * 0.06,
                      height: Get.width * 0.06,
                    )),
                Text(
        ...
        children: [
          Container(
              ...
              child: Row(
                ...
                children: [
                  Image.asset(
                    "assets/icons/have_new_list.png",
                    width: Get.width * 0.07,
                    height: Get.width * 0.07,
                  ),
                  Text(
