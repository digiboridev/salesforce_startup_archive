...
class SalesforcePlugin {
  factory SalesforcePlugin() {
    _singleton ??= SalesforcePlugin._(
        const MethodChannel('com.salesforce.flutter.SalesforcePlugin'));
    return _singleton!;
  }
  ...
  */
  ...
  static Future<Map> sendRequest(
    ...
    final Object response = await _platform._channel
        .invokeMethod('network#sendRequest', <String, dynamic>{
      'endPoint': endPoint,
      'path': path,
      'method': method,
      'queryParams': payload,
    ...
    final responseBody =
        response is Map ? response : json.decode(response.toString());
  ...
  */
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> describeGlobal() =>
      sendRequest(path: '/$_apiVersion/sobjects/');
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> metadata(String objtype) =>
      sendRequest(path: '/$_apiVersion/sobjects/sobjects/$objtype/');
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> describe(String objtype) =>
      sendRequest(path: '/$_apiVersion/sobjects/sobjects/$objtype/describe/');
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> describeLayout(String objtype,
          {String recordTypeId = ''}) =>
      sendRequest(
          path:
              '/$_apiVersion/sobjects/$objtype/describe/layouts/$recordTypeId');
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> create(String objtype, Map fields) => sendRequest(
      path: '/$_apiVersion/sobjects/$objtype/',
      method: 'POST',
      payload: fields);
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> retrieve(String objtype, String id, Map fields) =>
      sendRequest(
          path: '/$_apiVersion/sobjects/$objtype/$id',
          method: 'GET',
          payload: fields);
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> upsert(String objtype, String externalIdField,
          String? externalId, Map fields) =>
      sendRequest(
          path:
              '/$_apiVersion/sobjects/$objtype/$externalIdField/${externalId ?? ''}',
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> update(String objtype, String id, Map fields) =>
      sendRequest(
          path: '/$_apiVersion/sobjects/$objtype/$id',
          method: "PATCH",
          payload: fields);
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> del(String objtype, String id) => sendRequest(
      path: '/$_apiVersion/sobjects/$objtype/$id', method: "DELETE");
  ...
  */
  static Future<Map> query(String soql) =>
      sendRequest(path: "/$_apiVersion/query", payload: {'q': soql});
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> queryMore(String url) =>
      sendRequest(endPoint: '', path: url.split('/https:\/\/[^/]*(.*)/').last);
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> search(String soql) =>
      sendRequest(path: "/$_apiVersion/search", payload: {'q': soql});
   ...
   * @param [error=null] function called in case of error
  */
  static Future<Map> getAttachment(String id) => sendRequest(
      path: "/$_apiVersion/sobjects/Attachment/$id/Body",
      method: 'GET',
      returnBinary: true);
  ...
  static Future<Map> getAuthCredentials() async {
    final Object? response =
        await _platform._channel.invokeMethod('oauth#getAuthCredentials');
    return response is Map ? response : json.decode(response?.toString() ?? '');
  }

  static Future<Object> getClientInfo() async {
    final Object response =
        await _platform._channel.invokeMethod('oauth#getClientInfo');
    return response;
  }
  ...
  static Future<Map> registerForNotifications(
      String token, String? communityId, String packageName) async {
